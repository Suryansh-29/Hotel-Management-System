...
void HOTEL::display() {
    ...
    while (fin.read((char*)this, sizeof(HOTEL))) {
        if (room_no == r) {
            system("CLS");
            cout << "\n+-----------------+---------------------------------+"
                 << "\n| Room Number     | " << setw(31) << setfill(' ') << room_no << " |"
                 << "\n+-----------------+---------------------------------+"
                 << "\n| Name            | " << setw(31) << setfill(' ') << name << " |"
                 << "\n+-----------------+---------------------------------+"
                 << "\n| Address         | " << setw(31) << setfill(' ') << address << " |"
                 << "\n+-----------------+---------------------------------+"
                 << "\n| Phone Number    | " << setw(31) << setfill(' ') << phone << " |"
                 << "\n+-----------------+---------------------------------+"
                 << "\n| Days of Stay    | " << setw(31) << setfill(' ') << days << " |"
                 << "\n+-----------------+---------------------------------+"
                 << "\n| Room Type       | " << setw(31) << setfill(' ') << rtype << " |"
                 << "\n+-----------------+---------------------------------+"
                 << "\n| Total Cost      | " << setw(31) << setfill(' ') << cost << " |"
                 << "\n+-----------------+---------------------------------+";
            flag = 1;
            break;
        }
